...
def main() -> int:
    ...
    p.add_argument("command", choices=["validate", "fast", "diagnostic", "full", "adapt_full", "report"])
    p.add_argument("--mode", choices=["fast", "diagnostic", "full", "adapt_full"], default=None)
    ...
    mode = a.command if a.command in {"fast","diagnostic","full","adapt_full"} else a.mode
    try:
