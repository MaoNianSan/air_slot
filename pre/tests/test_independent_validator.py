...
def test_independent_validator_recomputes_instead_of_trusting_json(tmp_path) -> None:
    reports = tmp_path / "reports"
    reports.mkdir()
    (reports / "core_validation.json").write_text(
...
def test_independent_validator_passes_complete_synthetic_bundle(tmp_path) -> None:
