...
no-induced modes are not formal production switches. Any non-A00 candidate with response parameters
not marked `FROZEN` is forced out of the formal aggregate and cannot claim an authoritative rank.
