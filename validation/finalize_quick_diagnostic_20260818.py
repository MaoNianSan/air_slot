...
from exp1_lead_quantiles_quick_20260818 import (
    JSON_PATH,
    MD_PATH,
    write_markdown,
)  # noqa: E402
...
LEAD = {
    ...
    "variants": {
        "CURRENT": {
            ...
            "q75_min": 142.0,
            "iqr_min": 62.0,
            "positive_evaluable": 120092,
            "sustained_warning_count": 4686,
            "frozen_median_crosscheck": 105.0,
            "frozen_iqr_crosscheck": 62.0,
        ...
        "FIXED_HISTORY": {
            ...
            "iqr_min": 62.0,
            "positive_evaluable": 120092,
            "sustained_warning_count": 5772,
            "frozen_median_crosscheck": 108.0,
            "frozen_iqr_crosscheck": 62.0,
        ...
        "ADAPTIVE_HISTORY": {
            ...
            "iqr_min": 61.0,
            "positive_evaluable": 120092,
            "sustained_warning_count": 4325,
            "frozen_median_crosscheck": 109.0,
            "frozen_iqr_crosscheck": 61.0,
            "crosscheck_status": (
