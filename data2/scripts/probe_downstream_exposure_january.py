...
ref = build_data2_downstream_exposure(rows, fit_period="2019-01")
...
print("global_value_legs=", ref.global_value_legs)
print("global_sample_count=", ref.global_sample_count)
print("horizon_minutes=", ref.horizon_minutes)
...
print("top_airports=", ", ".join(f"{c.airport_id}:{c.value_legs:.2f}legs(n={c.sample_count})" for c in top))
print("rule=", ref.rule_id, ref.rule_version)
print("support=", ref.support_state.value)
print("PROBE_D2_5_JANUARY=DONE")