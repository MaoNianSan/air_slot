...
def test_solver_authority_reconciliation_is_scientifically_equivalent() -> None:
    ...
    assert report["scientific_contract_preserved"] is True
    assert report["stage_matched_orchestration_patch_applied"] is True
    assert report["scientific_exact_equality"] is False
