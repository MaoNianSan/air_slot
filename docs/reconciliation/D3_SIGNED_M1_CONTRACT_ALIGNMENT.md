...
Status: IMPLEMENTED_PENDING_HUMAN_REFREEZE
...
unchanged. The new H and W outputs are provisional evidence only. Permanent
`m1_hidden_size` and `m1_fixed_history_window_minutes` remain untouched until
the D3 human decision gate.
